...
public class Teclado extends Produto{
    ...
    // Construtor
    public Teclado(String nome, double preco, int qntEstoque, String categoria, String marca, int codigo, boolean isMecanico){
    ...
    // Construtor Vazio
    public Teclado(){
        this(null, 0, 0, null, null, 0, false);
    }
