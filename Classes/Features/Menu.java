...
public class Menu {
    ...
    private static Usuario loginScreen(Arvore<Usuario> tree, Scanner scnr) throws IOException, InterruptedException{
        ...
        System.out.println("Seja Bem-Vindo a Loja v:0.0.1!!");
    ...
    public static void mainScreen(Arvore<Usuario> tree, Lista<Produto> lista, Scanner scnr){
        try{
            ...
            if(x.getCode() == 0)
                ...
                // Loop até o usuario pedir para sair
                while((aux = clientScreen(scnr)) != 0){
                    clrScreen();
    ...
    private static int clientScreen(Scanner scnr){
        System.out.println("[1] Para Comprar Um Produto (Broke - nullPointer)");
        System.out.println("[2] Para Listar Os Produtos Disponíveis (Broke - Só aparece null)");
