...
public class Arvore<Type extends Comparable<Type>> implements Serializable {
    ...
    // Retorna uma String com os elementos da arvore pre-ordem
    public void preOrdem(No<Type> current){    
        if(current != null){
            System.out.println(current.getInfo()); // Armazena o valor em uma lista
            preOrdem(current.getAnterior()); // Entra no filho a esquerda
            preOrdem(current.getProximo()); // Entra no filho a direita
        }
    }

    // Retorna uma String com os elementos da arvore pos-ordem
    public void posOrdem(No<Type> current){    
        if(current != null){
            posOrdem(current.getAnterior()); // Entra no filho a esquerda
            posOrdem(current.getProximo()); // Entra no filho a direita
            System.out.println(current.getInfo()); // Armazena o valor em uma lista
        }
    }
